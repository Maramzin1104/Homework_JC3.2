...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String gamePathSave = "D://Homework_JC3.2/Games/savegames/save";
        String gamePathSaveZIP = "D://Homework_JC3.2/Games/savegames/save.zip";

        saveGame(gamePathSave, games);
        File dir = new File("D://Homework_JC3.2/Games/savegames/");
